...
export default function UploadForm({ nicheId }: UploadFormProps) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      // Ignora o erro 'PGRST116' que o Supabase retorna quando não encontra nenhuma linha, o que é o resultado esperado.
      ...
      const { error: insertError } = await supabase.from("videos").insert({
        ...
        description,
        video_url: videoUrl,
        scheduled_at: scheduled_at_iso, // Usando a data/hora combinada
